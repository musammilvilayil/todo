const CACHE='studyforge-pwa-v40';
const ASSETS=['./','./index.html','./app.js','./scheduler-v32.js','./live-day-v33.js','./pause-v34.js','./personal-os-v40.js','./personal-os-v40.css','./live-day-v33.css','./manifest.webmanifest','./icon.svg'];
